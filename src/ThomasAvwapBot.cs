...
{
    /// <summary>
    /// Version V2 de la stratégie AVWAP : mode unmanaged, suivi du compte et filtrage avancé.
    /// </summary>
    public class ThomasAvwapBot : Strategy
    {
        ...
        private bool flatEventPending; // flag déclenché par l'évènement compte, appliqué dans OnBarUpdate
        ...
        protected override void OnStateChange()
        {
            switch (State)
            {
                ...
                case State.DataLoaded:
                    ...
                    // Abonnement aux exécutions du COMPTE (bot + ordres manuels)
                    if (Account != null)
                        Account.ExecutionUpdate += OnAccountExecutionUpdate;

                    Print("INIT OK : AVWAP chargé + stratégie UNMANAGED (entrées auto, TP/SL manuels, tempo après déplacement AVWAP).");
                    break;
        ...
        protected override void OnBarUpdate()
        {
            ...
            // Flat du point de vue du COMPTE (bot + manuel)
            ...
            if (barTouchesAvwap
                ...
                && cooldownOK
                && avwapStable
                && State == State.Realtime)    // exécution temps réel uniquement
            {
                double limitPrice = 0;
                double stopPrice = 0;
        ...
        // === Suivi des exécutions au niveau COMPTE (bot + ordres manuels) ===
